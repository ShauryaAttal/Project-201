...
def calculate_interest():
    ...
    message=Label(result_frame,text="Interest on $"+str(p)+" with an interest rate of "+str(r)+"% for "+str(t)+" years is $"+str(interest), bg = "grey", font=("Calibri", 12), width=70)
...
principle_label=Label(window, text="Principle in Dollars", fg = "black", bg = "grey", font=("Calibri", 12),bd=1)
...
result=Label(result_frame,text="Your result will be displayed here", bg = "grey", font=("Calibri", 12), width=70)
